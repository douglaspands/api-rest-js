...
const fileModule = '../../../../app/api-usuarios-get';

describe('app/api-usuarios-get/index.js', () => {
  ...
  describe('#export default ()', () => {
    ...
    it('1 - Cadastramento de API com sucesso', done => {
      ...
      mock('../../../../app/api-usuarios-get/controller', function(req, res, next) { });
    ...
    it('2 - Cadastramento de API sem callback - Erro', done => {
      ...
      mock('../../../../app/api-usuarios-get/controller', null);
